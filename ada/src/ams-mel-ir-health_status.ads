...
package AMS.MEL.IR.Health_Status is
   ...
   function Create_Config
     (Channel_ID : UCI_ID; Platform_ID : UCI_ID;
      Sensor_Location : Component_Location) return Health_Config;
   ...
   function Capabilities (Channel : Health_Channel)
...
private
   ...
   overriding procedure Finalize (Channel : in out Health_Channel);
