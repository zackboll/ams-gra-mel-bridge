...
int main(void)
{
    ...
    (void)register_comms; (void)get_cap; (void)view_cap; (void)close_cap;
    (void)health_open; (void)health_enable; (void)health_cap; (void)health_close;
    (void)health_metadata_open; (void)health_receive; (void)health_counters;
    (void)health_metadata_close; (void)health_view; (void)health_event_close;
...
#define RECORD(type, ...) LAYOUT(type); __VA_ARGS__
    ...
    RECORD(ams_mel_bit_type_span_v1, FIELD(ams_mel_bit_type_span_v1,data); FIELD(ams_mel_bit_type_span_v1,size)); RECORD(ams_mel_bit_configuration_v1, FIELD(ams_mel_bit_configuration_v1,bit_types));
    RECORD(ams_mel_active_bit_v1, FIELD(ams_mel_active_bit_v1,bit_id); FIELD(ams_mel_active_bit_v1,estimated_completion_time_ns); FIELD(ams_mel_active_bit_v1,estimated_percent_complete)); RECORD(ams_mel_active_bit_span_v1, FIELD(ams_mel_active_bit_span_v1,data); FIELD(ams_mel_active_bit_span_v1,size));
    RECORD(ams_mel_completed_bit_item_v1, FIELD(ams_mel_completed_bit_item_v1,bit_item_name); FIELD(ams_mel_completed_bit_item_v1,result); FIELD(ams_mel_completed_bit_item_v1,fail_reason)); RECORD(ams_mel_completed_bit_item_span_v1, FIELD(ams_mel_completed_bit_item_span_v1,data); FIELD(ams_mel_completed_bit_item_span_v1,size));
    RECORD(ams_mel_completed_bit_v1, FIELD(ams_mel_completed_bit_v1,bit_id); FIELD(ams_mel_completed_bit_v1,time_tag_ns); FIELD(ams_mel_completed_bit_v1,result); FIELD(ams_mel_completed_bit_v1,fail_reason); FIELD(ams_mel_completed_bit_v1,bit_items)); RECORD(ams_mel_completed_bit_span_v1, FIELD(ams_mel_completed_bit_span_v1,data); FIELD(ams_mel_completed_bit_span_v1,size));
    RECORD(ams_mel_fault_data_v1, FIELD(ams_mel_fault_data_v1,key); FIELD(ams_mel_fault_data_v1,value); FIELD(ams_mel_fault_data_v1,format); FIELD(ams_mel_fault_data_v1,units)); RECORD(ams_mel_fault_data_span_v1, FIELD(ams_mel_fault_data_span_v1,data); FIELD(ams_mel_fault_data_span_v1,size));
    ...
    RECORD(ams_mel_ir_bad_pixel_v1, FIELD(ams_mel_ir_bad_pixel_v1,row); FIELD(ams_mel_ir_bad_pixel_v1,column); FIELD(ams_mel_ir_bad_pixel_v1,reason)); RECORD(ams_mel_ir_bad_pixel_span_v1, FIELD(ams_mel_ir_bad_pixel_span_v1,data); FIELD(ams_mel_ir_bad_pixel_span_v1,size)); RECORD(ams_mel_ir_bad_pixel_list_v1, FIELD(ams_mel_ir_bad_pixel_list_v1,reported_size); FIELD(ams_mel_ir_bad_pixel_list_v1,reported_count); FIELD(ams_mel_ir_bad_pixel_list_v1,pixels)); RECORD(ams_mel_ir_az_el_v1, FIELD(ams_mel_ir_az_el_v1,azimuth_rad); FIELD(ams_mel_ir_az_el_v1,elevation_rad)); RECORD(ams_mel_ir_line_of_sight_report_v1, FIELD(ams_mel_ir_line_of_sight_report_v1,system_time_ns); FIELD(ams_mel_ir_line_of_sight_report_v1,pointing_angle); FIELD(ams_mel_ir_line_of_sight_report_v1,pointing_angle_rates); FIELD(ams_mel_ir_line_of_sight_report_v1,at_speed); FIELD(ams_mel_ir_line_of_sight_report_v1,in_tolerance); FIELD(ams_mel_ir_line_of_sight_report_v1,platform_attitude); FIELD(ams_mel_ir_line_of_sight_report_v1,validity_flag_bitfield); FIELD(ams_mel_ir_line_of_sight_report_v1,image_rotation_rad)); RECORD(ams_mel_ir_line_of_sight_euler_v1, FIELD(ams_mel_ir_line_of_sight_euler_v1,system_time_ns); FIELD(ams_mel_ir_line_of_sight_euler_v1,attitude); FIELD(ams_mel_ir_line_of_sight_euler_v1,attitude_rates)); RECORD(ams_mel_ir_navigation_response_v1, FIELD(ams_mel_ir_navigation_response_v1,system_time_ns); FIELD(ams_mel_ir_navigation_response_v1,command_id); FIELD(ams_mel_ir_navigation_response_v1,request_id)); RECORD(ams_mel_ir_image_metadata_event_v1, FIELD(ams_mel_ir_image_metadata_event_v1,kind); FIELD(ams_mel_ir_image_metadata_event_v1,bad_pixel_list); FIELD(ams_mel_ir_image_metadata_event_v1,line_of_sight_report); FIELD(ams_mel_ir_image_metadata_event_v1,line_of_sight_euler); FIELD(ams_mel_ir_image_metadata_event_v1,navigation_response));
    ...
    RECORD(ams_mel_euler_v1, FIELD(ams_mel_euler_v1,roll); FIELD(ams_mel_euler_v1,pitch); FIELD(ams_mel_euler_v1,yaw)); RECORD(ams_mel_foreign_key_v1, FIELD(ams_mel_foreign_key_v1,key); FIELD(ams_mel_foreign_key_v1,system_name));
    RECORD(ams_mel_installation_details_v1, FIELD(ams_mel_installation_details_v1,location); FIELD(ams_mel_installation_details_v1,orientation); FIELD(ams_mel_installation_details_v1,boresight)); RECORD(ams_mel_temperature_status_v1, FIELD(ams_mel_temperature_status_v1,temperature_c); FIELD(ams_mel_temperature_status_v1,state));
    RECORD(ams_mel_mfa_component_v1, FIELD(ams_mel_mfa_component_v1,component_id); FIELD(ams_mel_mfa_component_v1,state); FIELD(ams_mel_mfa_component_v1,temperature); FIELD(ams_mel_mfa_component_v1,installation_location_id); FIELD(ams_mel_mfa_component_v1,installation_details)); RECORD(ams_mel_mfa_component_span_v1, FIELD(ams_mel_mfa_component_span_v1,data); FIELD(ams_mel_mfa_component_span_v1,size));
    RECORD(ams_mel_about_v1, FIELD(ams_mel_about_v1,model); FIELD(ams_mel_about_v1,serial_number); FIELD(ams_mel_about_v1,software_version); FIELD(ams_mel_about_v1,bootloader_software_version); FIELD(ams_mel_about_v1,hardware_version)); RECORD(ams_mel_mfa_status_v1, FIELD(ams_mel_mfa_status_v1,state); FIELD(ams_mel_mfa_status_v1,state_description); FIELD(ams_mel_mfa_status_v1,mode_description); FIELD(ams_mel_mfa_status_v1,transition_status); FIELD(ams_mel_mfa_status_v1,about); FIELD(ams_mel_mfa_status_v1,components));
    RECORD(ams_mel_ir_subsystem_dep_info_v1, FIELD(ams_mel_ir_subsystem_dep_info_v1,subsystem_id); FIELD(ams_mel_ir_subsystem_dep_info_v1,criticality); FIELD(ams_mel_ir_subsystem_dep_info_v1,failure)); RECORD(ams_mel_ir_subsystem_dep_info_span_v1, FIELD(ams_mel_ir_subsystem_dep_info_span_v1,data); FIELD(ams_mel_ir_subsystem_dep_info_span_v1,size));
    RECORD(ams_mel_ir_version_v1, FIELD(ams_mel_ir_version_v1,source); FIELD(ams_mel_ir_version_v1,major_revision); FIELD(ams_mel_ir_version_v1,minor_revision); FIELD(ams_mel_ir_version_v1,engineering_revision)); RECORD(ams_mel_ir_subsystem_csci_info_v1, FIELD(ams_mel_ir_subsystem_csci_info_v1,csci); FIELD(ams_mel_ir_subsystem_csci_info_v1,mode); FIELD(ams_mel_ir_subsystem_csci_info_v1,version); FIELD(ams_mel_ir_subsystem_csci_info_v1,criticality); FIELD(ams_mel_ir_subsystem_csci_info_v1,failure); FIELD(ams_mel_ir_subsystem_csci_info_v1,bit_report); FIELD(ams_mel_ir_subsystem_csci_info_v1,connection_established)); RECORD(ams_mel_ir_subsystem_csci_info_span_v1, FIELD(ams_mel_ir_subsystem_csci_info_span_v1,data); FIELD(ams_mel_ir_subsystem_csci_info_span_v1,size));
    ...
    RECORD(ams_mel_ir_hot_region_v1, FIELD(ams_mel_ir_hot_region_v1,type); FIELD(ams_mel_ir_hot_region_v1,size); FIELD(ams_mel_ir_hot_region_v1,top); FIELD(ams_mel_ir_hot_region_v1,left); FIELD(ams_mel_ir_hot_region_v1,right); FIELD(ams_mel_ir_hot_region_v1,bottom));
    RECORD(ams_mel_ir_hot_region_span_v1, FIELD(ams_mel_ir_hot_region_span_v1,data); FIELD(ams_mel_ir_hot_region_span_v1,size));
    RECORD(ams_mel_ir_candidate_object_header_v1, FIELD(ams_mel_ir_candidate_object_header_v1,number_of_cos); FIELD(ams_mel_ir_candidate_object_header_v1,stack_frame_index); FIELD(ams_mel_ir_candidate_object_header_v1,cfar); FIELD(ams_mel_ir_candidate_object_header_v1,validity_flag_bitfield); FIELD(ams_mel_ir_candidate_object_header_v1,tov_utc_ns));
    RECORD(ams_mel_ir_candidate_object_v1, FIELD(ams_mel_ir_candidate_object_v1,system_time_ns); FIELD(ams_mel_ir_candidate_object_v1,detection_category); FIELD(ams_mel_ir_candidate_object_v1,sensor_index); FIELD(ams_mel_ir_candidate_object_v1,subpixel); FIELD(ams_mel_ir_candidate_object_v1,intensity); FIELD(ams_mel_ir_candidate_object_v1,sensor_relative_unit); FIELD(ams_mel_ir_candidate_object_v1,signal_to_interference_ratio); FIELD(ams_mel_ir_candidate_object_v1,signal_to_noise_ratio));
    RECORD(ams_mel_ir_candidate_object_span_v1, FIELD(ams_mel_ir_candidate_object_span_v1,data); FIELD(ams_mel_ir_candidate_object_span_v1,size));
    RECORD(ams_mel_ir_candidate_object_message_v1, FIELD(ams_mel_ir_candidate_object_message_v1,header); FIELD(ams_mel_ir_candidate_object_message_v1,inertial_state); FIELD(ams_mel_ir_candidate_object_message_v1,hot_regions); FIELD(ams_mel_ir_candidate_object_message_v1,candidate_objects));
